...
frappe.query_reports["FIBS Bank File"] = {
	"filters": [
		{
		...
		},
		{
			...
			"label":__("Bank Name"),
			"fieldtype":"Select",
			"options":[" ", "BSP", "TDB", "ANZ", "MBF","SIA","FEDERAL"],
			"width": "90px",
//			"reqd": 1
		},
//		{
...
//		},
	...
	if (filters.bank_name) {
		return frappe.call({
			method: "fibs.fibs_application.report.fibs_bank_file.fibs_bank_file.create_bank_eft_file",
			args: {
